...
const entities = {
  ...
  argon: {
     ...
     licenses: [
       ...
       { type: 'envoy_access', name: 'Envoy Sales Contract', icon: 'menu_unlocked', price: 1 },
  ...
  hatikvah: {
     ...
     licenses: [
       ...
       { type: 'station_gen_advanced', name: 'Free League Advanced Module Licence', icon: '', price: 0 },
       { type: 'station_gen_basic', name: 'Free League Basic Module Licence', icon: '', price: 0 },
       { type: 'station_gen_intermediate', name: 'Free League Intermediate Module Licence', icon: '', price: 0 },
  ...
  holyorder: {
     ...
     licenses: [
       ...
       { type: 'hyperion_access', name: 'Hyperion Sale Contract', icon: 'menu_unlocked', price: 1 },
       ...
       { type: 'story_paranid_palace_module', name: 'Paranid Palace Module Licence', icon: 'menu_unlocked', price: 1 },
  ...
  yaki: {
     ...
     race: Races.argon,
      icon: 'faction_yaki',
     licenses: [
       { type: 'ceremonyally', name: 'Honourable Dragon', icon: '', price: 0 },
  ...
  kaori: {
     ...
     version: 1,
     name: 'Quettanauts',
     description: 'According to their own tales, the ancestors of the Quettanauts are believed to have been drawn from all around the galaxy to found their civilisation. What could have caused this congregation of disparate races is the topic of much speculation, with theories ranging from ships getting lost in spatial anomalies to splinter factions heading off and encountering others with similar goals. Some of the more outlandish theories involve the Quettanauts being able to traverse the galaxy at will, unnoticed by others, and either rescuing or abducting new members, depending on who is telling this tale. One thing is certain, however: it is incredibly unlikely that the original genesis of the Quettanauts will ever be fully uncovered, and will remain lost to time.nnAt the heart of Quettanaut society lies their distinctive barter economy. Unlike other factions that rely on credits, Quettanauts prefer to trade goods and services directly. This decentralised system allows for a more fluid exchange of resources, and fosters a sense of self-sufficiency.',
     race: Races.argon,
      icon: 'faction_kaori',
     licenses: [
       { type: 'ceremonyally', name: 'Mitsuno\'s Trusted Adviser', icon: '', price: 0 },
       { type: 'ceremonyfriend', name: 'Mitsuno\'s Friend', icon: '', price: 0 },
       { type: 'generaluseequipment', name: 'Quettanauts General Use Equipment Licence', icon: '', price: 0 },
       { type: 'police', name: 'Quettanauts Police Licence', icon: '', price: 0 },
       { type: 'station_gen_advanced', name: 'Quettanauts Advanced Module Licence', icon: '', price: 0 },
       { type: 'station_gen_basic', name: 'Quettanauts Basic Module Licence', icon: '', price: 0 },
       { type: 'station_gen_intermediate', name: 'Quettanauts Intermediate Module Licence', icon: '', price: 0 },
     ],
 },
};
