...
export const Modules = {
  module_arg_conn_arc_01: {
   id: 'module_arg_conn_arc_01',
	  version: 0,
   name: 'Argon 圆弧连接结构 01',
   macro: 'struct_arg_arc_01_macro',
   description: '无可用信息',
   type: ModuleTypes.connectionmodule,
   hull: 290000,
   price: { min: 101601, max: 137461, avg: 119531 },
   owners: [
    Factions.antigone,
    Factions.argon,
   ],
  ...
  module_arg_conn_cross_02: {
   id: 'module_arg_conn_cross_02',
	  version: 0,
   name: 'Argon 交叉连接结构 02',
   macro: 'struct_arg_cross_02_macro',
   description: '无可用信息',
   type: ModuleTypes.connectionmodule,
   hull: 110000,
   price: { min: 63911, max: 86467, avg: 75189 },
   owners: [
    Factions.antigone,
    Factions.argon,
   ],
  ...
  module_arg_conn_cross_03: {
   id: 'module_arg_conn_cross_03',
	  version: 0,
   name: 'Argon 交叉连接结构 03',
   macro: 'struct_arg_cross_03_macro',
   description: '无可用信息',
   type: ModuleTypes.connectionmodule,
   hull: 100000,
   price: { min: 59572, max: 80597, avg: 70084 },
   owners: [
    Factions.antigone,
    Factions.argon,
   ],
  ...
  module_arg_conn_cross_04: {
   id: 'module_arg_conn_cross_04',
	  version: 0,
   name: 'Argon T 型连接结构 01',
   macro: 'struct_arg_cross_04_macro',
   description: '无可用信息',
   type: ModuleTypes.connectionmodule,
   hull: 90000,
   price: { min: 55263, max: 74768, avg: 65016 },
   owners: [
    Factions.antigone,
    Factions.argon,
   ],
  ...
  module_arg_conn_cross_05: {
   id: 'module_arg_conn_cross_05',
	  version: 0,
   name: 'Argon L 型连接结构 01',
   macro: 'struct_arg_cross_05_macro',
   description: '无可用信息',
   type: ModuleTypes.connectionmodule,
   hull: 80000,
   price: { min: 50924, max: 68898, avg: 59911 },
   owners: [
    Factions.antigone,
    Factions.argon,
   ],
  ...
  module_arg_pier_l_04: {
   id: 'module_arg_pier_l_04',
	  version: 0,
   name: 'Argon 紧缩型-1x大型泊位 码头',
   macro: 'pier_arg_harbor_04_macro',
   description: '无可用信息',
   type: ModuleTypes.pier,
   explosionDamage: 1000,
   hull: 180000,
   makerRace: Races.argon,
   price: { min: 1224857, max: 1657160, avg: 1441009 },
   owners: [
    Factions.antigone,
    Factions.argon,
   ],
    production: [
     {
       ...
       name: '常规',
       wares: [
         { ware: 'claytronics', amount: 219 },
         { ware: 'energycells', amount: 799 },
         { ware: 'hullparts', amount: 856 },
       ],
     },
    ]
  },
  ...
  module_arg_radar_dish_01: {
   id: 'module_arg_radar_dish_01',
	  version: 0,
   name: '广域传感器阵列',
   macro: 'radar_arg_dish_01_macro',
   description: '无可用信息',
   type: ModuleTypes.radar,
   explosionDamage: 1000,
   hull: 110000,
   price: { min: 897249, max: 1213926, avg: 1055588 },
   owners: [
    Factions.alliance,
    Factions.antigone,
    Factions.argon,
    ...
    production: [
     ...
     },
     {
       ...
       name: 'Terran',
       wares: [
         { ware: 'computronicsubstrate', amount: 33 },
         { ware: 'energycells', amount: 2880 },
         { ware: 'siliconcarbide', amount: 106 },
       ],
     },
    ]
  },
  ...
  module_arg_stor_container_m_01: {
   ...
   hull: 285000,
   makerRace: Races.argon,
   cargo: { max: 250000, type: CargoTypes.container },
  ...
  module_arg_stor_container_s_01: {
   ...
   hull: 114000,
   makerRace: Races.argon,
   cargo: { max: 50000, type: CargoTypes.container },
  ...
  module_gen_conn_observationdeck_01: {
   id: 'module_gen_conn_observationdeck_01',
	  version: 0,
   name: '横向观景平台',
   macro: 'struct_gen_observationdeck_01_macro',
   description: '无可用信息',
   type: ModuleTypes.connectionmodule,
   hull: 170000,
   price: { min: 190696, max: 258000, avg: 224348 },
   owners: [
    Factions.alliance,
    Factions.antigone,
    Factions.argon,
    ...
    production: [
     {
       ...
       wares: [
         ...
         { ware: 'energycells', amount: 1262 },
         { ware: 'hullparts', amount: 169 },
       ],
     },
     {
       time: 205,
       ...
       wares: [
         ...
         { ware: 'energycells', amount: 631 },
         { ware: 'siliconcarbide', amount: 21 },
       ],
     },
    ]
  },
  module_gen_conn_observationdeck_02: {
   id: 'module_gen_conn_observationdeck_02',
	  version: 0,
   name: '纵向观景平台',
   macro: 'struct_gen_observationdeck_02_macro',
   description: '无可用信息',
   type: ModuleTypes.connectionmodule,
   hull: 170000,
   price: { min: 200150, max: 270792, avg: 235471 },
   owners: [
    Factions.alliance,
    Factions.antigone,
    Factions.argon,
    ...
    production: [
     {
       ...
       name: '常规',
       wares: [
         { ware: 'claytronics', amount: 23 },
         { ware: 'energycells', amount: 1325 },
         { ware: 'hullparts', amount: 177 },
       ],
     },
     {
       time: 225,
       ...
       wares: [
         ...
         { ware: 'energycells', amount: 662 },
         { ware: 'siliconcarbide', amount: 22 },
       ],
     },
    ]
  },
  module_gen_conn_observationdeck_03: {
   id: 'module_gen_conn_observationdeck_03',
	  version: 0,
   name: '观景天台',
   macro: 'struct_gen_observationdeck_03_macro',
   description: '无可用信息',
   type: ModuleTypes.connectionmodule,
   hull: 170000,
   price: { min: 216484, max: 292890, avg: 254687 },
   owners: [
    Factions.alliance,
    Factions.antigone,
    Factions.argon,
    ...
    production: [
     {
       ...
       wares: [
         ...
         { ware: 'energycells', amount: 1433 },
         { ware: 'hullparts', amount: 192 },
       ],
     },
     {
       time: 245,
       ...
       wares: [
         { ware: 'computronicsubstrate', amount: 8 },
         { ware: 'energycells', amount: 716 },
         { ware: 'siliconcarbide', amount: 24 },
       ],
     },
    ]
  },
  ...
  module_gen_proc_scrapworks: {
   ...
   description: '星门关闭后的 Avarice｜贪婪 星系内资源极为有限，受困于此的Argon工程师因而开始开发各种回收设施。废料处理设施是其中之一，该模块将S和M级飞船残骸内的原始废料处理为废金属，以便回收再生为可用的资源。第一艘拖船也同步开发完成，用于将残骸运送到废料处理设施。随后废料块出现了，更大的残骸会被打包成这种方块以便于拖曳和处理。nn来自 Sacred Relic｜神圣遗迹 的信使无人机到达之后，Avarice｜贪婪 的居民也向其他断连的星系派出了无人机。这些无人机搭载了回收再生技术的蓝图，以期对其他地方同样挣扎于自然资源短缺的受困者能有所帮助。为此，他们在破潮砥柱上建立了当地的约言联盟分部。星门于新纪元825年首次重新建立连接，约言联盟随后搬到了位于 Windfall | 横财 属于他们自己的空间站。',
    ...
    production: [
     {
       ...
       name: '常规',
       wares: [
         { ware: 'advancedcomposites', amount: 5630 },
         { ware: 'energycells', amount: 6571 },
         { ware: 'plasmaconductors', amount: 4737 },
       ],
     },
    ]
  },
    ...
    production: [
     {
       ...
       name: '常规',
       wares: [
         { ware: 'advancedcomposites', amount: 853 },
         { ware: 'energycells', amount: 1357 },
         { ware: 'plasmaconductors', amount: 1228 },
       ],
     },
    ]
  },
  ...
  module_gen_prod_scrap_recycler: {
   ...
   description: '星门关闭后的 Avarice｜贪婪 星系内资源极为有限，受困于此的Argon工程师因而开始开发各种回收设施。废料再生设施用于将废金属再生为可用资源，通过不同的生产流程将其转化为船体部件或电子黏土。nn来自 Sacred Relic｜神圣遗迹 的信使无人机到达之后，Avarice｜贪婪 的居民也向其他断连的星系派出了无人机。这些无人机搭载了回收再生技术的蓝图，以期对其他地方同样挣扎于自然资源短缺的受困者能有所帮助。为此，他们在破潮砥柱上建立了当地的约言联盟分部。星门于新纪元825年首次重新建立连接，约言联盟随后搬到了位于 Windfall | 横财 属于他们自己的空间站。',
   type: ModuleTypes.production,
  ...
  module_ter_prod_scrap_recycler: {
   ...
   description: '星门关闭后的 Avarice｜贪婪 星系内资源极为有限，受困于此的Argon工程师因而开始开发各种回收设施。废料再生设施用于将废金属再生为可用资源，通过不同的生产流程将其转化为船体部件或电子黏土。nn来自 Sacred Relic｜神圣遗迹 的信使无人机到达之后，Avarice｜贪婪 的居民也向其他断连的星系派出了无人机。这些无人机搭载了回收再生技术的蓝图，以期对其他地方同样挣扎于自然资源短缺的受困者能有所帮助。为此，他们在破潮砥柱上建立了当地的约言联盟分部。星门于新纪元825年首次重新建立连接，约言联盟随后搬到了位于 Windfall | 横财 属于他们自己的空间站。nn收到废料再生设施的蓝图后，赛格瑞斯先驱者将其改进成适用于Terran经济的形式。该版本的废料再生设施通过不同的生产流程产出碳化硅或电子基质而不是船体部件或电子黏土。',
   type: ModuleTypes.production,
  ...
  module_pir_stor_condensate_l_01: {
   ...
   description: '戍子护盾发生器由洛斯维尔公司研发团队设计开发。只要有冷凝态的戍子，它就能产生足以在毁灭性的星潮中保护整个空间站的护盾。这个过程会耗尽戍子。由于戍子这种物质储能极高又非常不稳定，这个模块被设计成只能储存少量戍子。',
   type: ModuleTypes.storage,
   explosionDamage: 1000,
   hull: 1000000,
...
export const AllModules = [
 Modules.module_arg_conn_arc_01,
 ...
 Modules.module_arg_conn_cross_02,
 Modules.module_arg_conn_cross_03,
 Modules.module_arg_conn_cross_04,
 Modules.module_arg_conn_cross_05,
 ...
 Modules.module_arg_radar_dish_01,
 ...
 Modules.module_gen_conn_observationdeck_01,
 Modules.module_gen_conn_observationdeck_02,
 Modules.module_gen_conn_observationdeck_03,
