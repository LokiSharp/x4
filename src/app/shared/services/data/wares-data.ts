...
export const Wares = {
 ...
 antimattercells: {
   id: 'antimattercells',
	  version: 0,
   name: '反物质单元',
   description: '用于存储反物质的高科技磁性存储装置。由于霍金辐射和使用自持电源，它们无法永久性存储反物质。存储单元生产后通过精炼氢获得反物质进行填充，主要用于引擎部件的制造，微型化后也可用在电子黏土上。',
 ...
 claytronics: {
   id: 'claytronics',
	  version: 0,
   name: '电子黏土',
   description: '电子黏土由数以百万计纳米级的独立计算机组成，即俗称的可编程物质。这项技术是所有非Xenon空间站的核心，从内部线路到计算机系统和控制系统——除了空间站站体之外的几乎一切都由它制造而成。随着星门关闭后整个宇宙都忙于重建，纳米计算机的需求量也因此一直居高不下。',
   factoryName: '电子黏土制造厂',
 ...
 graphene: {
   id: 'graphene',
	  version: 0,
   name: '石墨烯',
   description: '石墨烯在今天主要通过提炼和处理甲烷气体获得，是一种拥有许多特殊性能的半金属材料。由于石墨的强度、耐高温和导电性能，它经常被用于生产各种技术产品，同时也被用于强化船体结构。',
   factoryName: '石墨烯精炼厂',
   icon: 'ware_graphene',
   volume: 20,
   transport: TransportType.container,
 ...
 methane: {
   id: 'methane',
	  version: 0,
   name: '甲烷',
   description: '甲烷（CH4）在星门网络内的气态星云中广泛存在，采矿船采集后运送至精炼厂中将其精炼成石墨烯。',
   factoryName: '甲烷处理厂',
   icon: 'ware_methane',
   volume: 6,
   transport: TransportType.liquid,
 ...
 rawscrap: {
   id: 'rawscrap',
	  version: 0,
   name: '原始废料',
   description: '原始废料来源于残骸。它从大型飞船和空间站的残骸中提取，然后通过残骸打包船切割分解打包为标准尺寸的废料块。这些废料块以及尺寸较小的完整残骸都可由拖船收集送往废料处理设施，在那里它们将被熔融重铸为废金属以便后续再生利用。',
   factoryName: '',
 ...
 scrapmetal: {
   id: 'scrapmetal',
	  version: 0,
   name: '废金属',
   description: '废金属已经成为资源严重短缺地区经济的重要组成部分。废金属可通过打捞空间站废弃部件或回收飞船残骸来得到。它能够被再生为其他更有价值的材料。',
   factoryName: '废料处理站',
   icon: 'ware_scrapmetal',
   volume: 10,
   transport: TransportType.solid,
 ...
 spacefuel: {
   ...
   volume: 2,
   transport: TransportType.container,
   illegal: [ Factions.antigone, Factions.argon, Factions.pioneers, Factions.terran, Factions.boron ],
 ...
 spaceweed: {
   ...
   volume: 3,
   transport: TransportType.container,
   illegal: [ Factions.antigone, Factions.argon, Factions.holyorder, Factions.paranid, Factions.terran, Factions.boron ],
 ...
 computronicsubstrate: {
   id: 'computronicsubstrate',
	  version: 1,
   name: '电子基质',
   description: '电子基质是更为先进的Terran版可编程物质。组成基质的"原子"可以在差不多可以模拟任何元素和粒子，无论自然的还是人造的。这项优异的性能和它的广泛应用是现代Terran空间站和飞船设计的基础。',
   factoryName: '电子基质装配厂',
 ...
 bofu: {
   id: 'bofu',
	  version: 1,
   name: 'Bo腐',
   description: '众所周知，Bo腐餐既健康又有营养。Boron很喜欢它们，据说他们的飞行员仅靠一块Bo腐就能顶上将近一个星期。nnBo腐是在特殊的Bo腐化学实验室中利用浮游生物和其他秘密成分培育出来的。尽管 Boron以其美味的斯托特香料而闻名于其他种族，但除了他们自己，Bo腐的味道对其他任何人来说都是难以忍受的。',
   factoryName: 'Bo腐化学实验室',
   icon: 'ware_bofu',
   volume: 4,
   transport: TransportType.container,
 ...
 bogas: {
   id: 'bogas',
	  version: 1,
   name: 'Bo气',
   description: '这种在妮莎拉星球上发现的不寻常的自然资源预示着这个星球就像是一个巨大的化学工厂。从这些化学物质中，Boron制造出一种独特的气体，在整个宇宙中被用作终极止痛剂和麻醉剂。nn在Boron政府停止对其星球上的自然资源进行任何商业利用之后，Bo气现在是在Boron女王国各个Bo气合成酿造厂中被人工复制出来。',
   factoryName: 'Bo气合成酿造厂',
   icon: 'ware_bogas',
   volume: 4,
   transport: TransportType.container,
 ...
 plankton: {
   id: 'plankton',
	  version: 1,
   name: '浮游生物',
   description: 'Boron浮游生物是以浮渣的形式出现的，漂浮在妮莎拉星球的化学沼泽的表面。nn这种浮渣被收集起来，然后用添加剂和其他Boron矿物质进行处理，以生产各种有营养的调味品。由于Boron海洋现在被完全保护起来，禁止用于任何工业用途上，现在浮游生物主要是在Boron女王国太空中随处可见巨大的浮游生物养殖场中生产。',
   factoryName: '浮游生物养殖场',
   icon: 'ware_plankton',
   volume: 1,
   transport: TransportType.container,
