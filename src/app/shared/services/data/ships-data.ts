...
export const Ships = [
  ...
  },
  {
   id: 'ship_tel_l_destroyer_02_a',
	  version: 0,
   name: 'Phoenix E',
   description: 'When the Teladi Company commissioned a redesign of the Phoenix destroyer, their goal wasn\'t to create an all-conquering superweapon. Instead, their focus was to build a robust capital ship able to withstand the rigours of battle long enough for reinforcements to arrive.nnIn this regard, commanders concede that, as a defensive platform, the designers succeeded. The Phoenix is built on a steadfast chassis. The designers are said to be particularly proud of an intelligently dispersed engine placement, where the previous model\'s cluster resembled an enticing invitation for torpedo targeting.nnThe E-model variation was introduced at a later date, and updated the superficial design to bring it up to par with Commonwealth standards that were established during the period of disconnection. The precursor version is slowly being phased out, but will remain available for interested third parties.',
   size: Size.large,
   race: Races.teladi,
   explosionDamage: 1000,
   hull: 112000,
  ...
  },
  {
   id: 'ship_tel_l_miner_liquid_02_a',
	  version: 0,
   name: 'Crane E (Gas)',
   description: 'The Teladi Crane is a large miner with truly impressive load carrying capacity. Fulfilling a major part of Teladi primary resource acquisition, the Crane is available in models optimised for either mineral or gas collection.nnThe E-model variation was introduced at a later date, and updated the superficial design to bring it up to par with Commonwealth standards that were established during the period of disconnection. The precursor version is slowly being phased out, but will remain available for interested third parties.',
   size: Size.large,
   race: Races.teladi,
   explosionDamage: 800,
   hull: 34800,
  ...
  },
  {
   id: 'ship_tel_l_trans_container_03_a',
	  version: 0,
   name: 'Heron E',
   description: 'The Teladi Company\'s Heron is a large freighter. It is noted for its somewhat relaxed pace, which is in keeping with mainstream Teladi design values.nnThe E-model variation was introduced at a later date, and updated the superficial design to bring it up to par with Commonwealth standards that were established during the period of disconnection. The precursor version is slowly being phased out, but will remain available for interested third parties.',
   size: Size.large,
   race: Races.teladi,
   explosionDamage: 800,
   hull: 64000,
  ...
  },
  {
   ...
   description: 'There are faster scouts than the Teladi Kestrel, yet it still manages to function respectably. It is more solid than most of its competitors, and has respectable shield energy.nnPilots commonly opt for the somewhat faster Vanguard model.',
   size: Size.small,
   race: Races.teladi,
   hull: 2500,
   storage: { missile: 20, unit: 0 },
  ...
  },
  {
   id: 'ship_gen_s_racer_01_a',
	  version: 1,
   name: 'Dart',
   description: 'The Dart was initially released as a mail-in kit project, to which an aspiring racer could subscribe and have parts shipped to them periodically. Due to its popularity, the Dart was quickly offered as a ready-to-fly ship, and the project took no new kit customers.nnIt is easy to identify a kit-built Dart from a production one, as the tooling for the rear titanium fins was recreated due to complaints about the fins\' shape not fitting that of the rest of the ship.nnDespite being discontinued, the kits remain remarkably popular, and incomplete kits regularly sell for beyond the price of a production ship.',
   size: Size.small,
   hull: 2100,
   storage: { missile: 0, unit: 0 },
   people: 0,
  ...
  },
  {
   id: 'ship_tel_s_racer_01_a',
	  version: 1,
   name: 'Kestrel Sport',
   description: 'There are faster scouts than the Teladi Kestrel, yet it still manages to function respectably. It is more solid than most of its competitors, and has respectable shield energy.nnThe Kestrel Sport, however, has squeezed every last bit of speed out of the chassis, at the cost of some of its stability, making it a popular choice for more experienced racers.',
   size: Size.small,
   race: Races.teladi,
   hull: 2500,
   storage: { missile: 0, unit: 0 },
  ...
  },
  {
   id: 'ship_gen_m_corvette_01',
	  version: 1,
   name: 'Envoy',
   description: 'A joint development by the Argon Federation and the Teladi Ministry of Finance, the Envoy integrates each faction\'s latest technologies. The Envoy class is equipped with exclusive high-performance engines and shield generators, unavailable to other vessels.nnThe joint technology program also included the development of a set of heavy weapons specific to the Envoy. Due to market demand, turret variants of those weapons were also introduced. These variants are compatible with a wide variety of ships, but some ships are excluded due to technical constraints. The ship also includes two forward-facing hardpoints, supporting a range of conventional weaponry for tactical flexibility.nnA dedicated low-signature stance is available, in which most weapon systems are concealed and inoperable. While in this configuration, the vessel exhibits reduced detectability and increased manoeuvrability, at the expense of speed.nnShip operators may also activate faction camouflage protocols, allowing the vessel to appear to belong to another faction when observed externally. These advanced protocols are licensed on a strictly individual basis, and are not available to employed personnel.',
   size: Size.medium,
   race: Races.argon,
   explosionDamage: 500,
   hull: 12800,
  ...
  },
  {
   id: 'ship_gen_m_corvette_02',
	  version: 1,
   name: 'Cypher',
   description: 'First observed shortly after the introduction of the Envoy, the Cypher\'s origins remain unclear. Though not officially linked to any known faction, it is frequently flown by pirates or other independent operators.nnWith some structural similarities to the Envoy, and capable of using the same exclusive engines, shields and primary weapons, the Cypher\'s main systems are typically supplemented with equipment acquired from Teladi or other manufacturers.nnAlthough the vessel lacks configurable stances, it retains the ability to engage identity-masking protocols, allowing it to mimic the transponder signature of other factions.',
   size: Size.medium,
   race: Races.teladi,
   explosionDamage: 500,
   hull: 10100,
